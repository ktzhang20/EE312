...
int main(void) {
    ...
    printf("change 4 should be 2d, 0n, 1p and is: %dd %dn %dp\n", change4.dodeks, change4.nicks, change4.pennies);
    Martian change5 = change(25, 6, 13);
    printf("change 5 should be 1d, 2n, 0p and is: %dd %dn %dp\n", change5.dodeks, change5.nicks, change5.pennies);

    Martian change6 = change(33, 8, 11);
    printf("change 6 should be 3d, 0n, 0p and is: %dd %dn %dp\n", change6.dodeks, change6.nicks, change6.pennies);

    Martian change7 = change(41, 9, 10);
    printf("change 7 should be 4d, 0n, 1p and is: %dd %dn %dp\n", change7.dodeks, change7.nicks, change7.pennies);

    Martian change8 = change(10, 11, 12);
    printf("change 8 should be 0d, 0n, 10p and is: %dd %dn %dp\n", change8.dodeks, change8.nicks, change8.pennies);
    Martian change9 = change(25,2,8);
    printf("change 9 should be 0d, 0n, 10p and is: %dd %dn %dp\n", change9.dodeks, change9.nicks, change9.pennies);
    Martian change10 = change(15,3,4);
